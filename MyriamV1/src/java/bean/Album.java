...
public class Album implements Serializable{
    ...
    public String toString() {
        return "Album{" + "id_album=" + id_album + ", titre_album=" + titre_album 
                + " nom_serie=" + nom_serie + " nom_editeur=" + nom_editeur + " nom_illustrateur=" 
                + nom_illustrateur + " nom_scenariste=" + nom_scenariste + " langue=" 
                + langue + " ISBN=" + ISBN + " nombre_exemplaire=" + nombre_exemplaire +'}';
    }
