...
public class Exemplaire implements Serializable{
    ...
    public String toString() {
        return "Exemplaire{" + "id_exemplaire=" + id_exemplaire + ", date_depot=" + date_depot 
                + " edition_originale=" + edition_originale + " date_achat=" + date_achat + " prix_achat=" 
                + prix_achat + " etat_conservation=" + etat_conservation + " note_texte=" 
                + note_texte + " id_album=" + id_album +'}';
    }
